...
struct NavigationMapView: View {
    ...
    @State private var minimizedAndReopened = false // Tracks if app was minimized and reopened
    @State private var wasMinimized = false // Tracks if app was minimized
    @State private var showBackAlert = false // Controls back button alert
        ...
        NavigationView {
            GeometryReader { geometry in
                ZStack {
                    ...
                    floatingButtons
                    emergencyCallButton
                    bottomCard // Now properly positioned at the bottom
                    expenseModal
                    emergencyCallOptionsView
                    filterOptionsView
                ...
                .fullScreenCover(isPresented: $navigateToPostInspection) {
                    PostInspectionView(
                        ...
                        vehicleNumber: vehicleNumber,
                        tripID: trip.id,
                        vehicleID: trip.vehicleId, isPresented: $navigateToPostInspection
                    )
                }
                .dismissKeyboard() // Apply keyboard dismissal at the root level
            }
