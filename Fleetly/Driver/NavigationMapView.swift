...
struct NavigationMapView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            .alert("Resume trip?", isPresented: Binding(
                ...
                Button("Cancel", role: .destructive) {
                    ...
                    navigateToPostInspection = true
                    print("User chose to cancel trip")
                }
            }
        }
    }
...
struct NavigationMapView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            .alert("Continue trip?", isPresented: Binding(
                get: { minimizedAndReopened && isTripStarted },
                set: { _ in }
            )) {
                Button("Resume") {
        ...
        GeometryReader { geometry in
            ...
            .background(
                Group {
                    ...
                    NavigationLink(
                        destination: MainView(authVM: authVM),
            ...
            .alert(isPresented: Binding(
                ...
                Alert(
                    ...
                    secondaryButton: .destructive(Text("Cancel")) {
                        ...
                        print("User chose to cancel trip, navigating to MainView")
                    }
                )
            }
        }
            ...
            .alert(isPresented: Binding(
                ...
                Alert(
                    ...
                    secondaryButton: .destructive(Text("Cancel")) {
                        ...
                        print("User chose to cancel trip, dismissing to MainView")
                        dismiss()
                    }
                )
            }
