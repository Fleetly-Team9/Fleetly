...
class PastRidesViewModel: ObservableObject {
    ...
    // Fetch completed rides with real-time updates
    func fetchCompletedRides() {
        ...
        listener = db.collection("trips")
            ...
            .addSnapshotListener { [weak self] snapshot, error in
                ...
                // Map top-level documents to Ride structs
                ...
                // Fetch subcollection data for each ride
                ...
                // Update rides after all subcollections are fetched
